...
## Description
This is an MVC application. It will let managers add engineers and machines to the database. Managers will be able to view machines that can be repaired by certain engineers and also view engieers details.

## Setup/Installation Requirements

Repository: https://github.com/glenbuck503/Factory.Solution.git
